...
public class panelProveedores extends JPanel {
     ...
     */
    public void generarPdfProveedores(Persona persona, String filePath) { // ¡Método actualizado para aceptar filePath!
        if (persona == null) {
        ...
        try {
            ...
            document.add(new Paragraph("Reporte de Proveedor - " + persona.getNumeroIdentificacion()).setFontSize(18).setBold());

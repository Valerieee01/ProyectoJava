...
public class paneInicioAdmi extends JPanel {
	 ...
	 * Create the panel.
	 */
    public paneInicioAdmi(CardLayout cardLayout, JPanel contenedorCardLayout) {
		...
		panelMantenimientos.setBounds(339, 71, 161, 238);
		...
		btnIrReportes.addActionListener(e -> cardLayout.show(contenedorCardLayout, "paneReportes"));

...
import menuInicialEmpleado.panelMantenimientosEmp;
...
public class FormularioMantenimientoEmp extends JDialog {
    ...
    private panelMantenimientosEmp panelMantenimientosEmpRef;
    ...
    public FormularioMantenimientoEmp(Window parent, MantenimientosDAO mantenimientosDAO, panelMantenimientosEmp panelMantenimientosEmpRef) {
        super(parent, "Nuevo Mantenimiento", ModalityType.APPLICATION_MODAL);
        this.mantenimientosDAO = mantenimientosDAO;
        this.panelMantenimientosEmpRef = panelMantenimientosEmpRef;
        this.esEdicion = false;
        configurarFormulario();
    }

    // Constructor para MODO EDITAR (más limpio: se pasa el objeto Mantenimiento)
    public FormularioMantenimientoEmp(Window parent, MantenimientosDAO mantenimientosDAO, panelMantenimientosEmp panelMantenimientosEmpRef, Mantenimiento mantenimientoParaEditar) {
    ...
    private void guardarOActualizarMantenimiento() {
        ...
        try (Connection conn = ConnectionADMIN.getConnectionADMIN()) {
            ...
            if (panelMantenimientosEmpRef != null) {
            	panelMantenimientosEmpRef.cargarMantenimientosEnTabla();
            }
            dispose();

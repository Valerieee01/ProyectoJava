...
import javax.swing.JFileChooser; // Importado
import javax.swing.JLabel;
import javax.swing.JOptionPane;
import javax.swing.JPanel;
import javax.swing.filechooser.FileNameExtensionFilter; // Importado para filtrar extensiones
...
import formularios.FormularioMantenimiento;
...
public class panelMantenimientos extends JPanel {
    ...
    private void abrirFormularioNuevoMantenimiento() {
        ...
        FormularioMantenimiento dialog = new FormularioMantenimiento(parent, mantenimientosDAO, this);
    ...
    private void editarMantenimientoSeleccionado() {
        ...
        try (Connection conn = ConnectionADMIN.getConnectionADMIN()) {
            ...
            if (mantenimientoAEditar != null) {
                Window parent = SwingUtilities.getWindowAncestor(this);
                FormularioMantenimiento dialog = new FormularioMantenimiento(parent, mantenimientosDAO, this, mantenimientoAEditar);
                dialog.setVisible(true);
            } else {
    ...
    public void generarPdfMantenimientos(Mantenimiento mantenimiento, String filePath) {
        ...
        try {
            ...
            try {
                ...
                // Podrías añadir un JOptionPane.showMessageDialog aquí también si quieres notificar al usuario.
            }

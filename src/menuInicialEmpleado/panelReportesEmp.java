...
import formulariosEmp.FormularioPagosEmp;
import modelos.Pagos;
import modelos.Pagos.EstadoPago; 
import util.ConnectionADMIN; 

public class panelReportesEmp extends JPanel {
    ...
    private void abrirFormularioNuevoPago() {
        ...
        FormularioPagosEmp dialog = new FormularioPagosEmp(parent, pagosDAO, this);
    ...
    private void editarPagoSeleccionado() {
        ...
        try (Connection conn = ConnectionADMIN.getConnectionADMIN()) {
            ...
            if (pagoAEditar != null) {
                ...
                FormularioPagosEmp dialog = new FormularioPagosEmp(parent, pagosDAO, this, pagoAEditar);
                dialog.setVisible(true);
            } else {

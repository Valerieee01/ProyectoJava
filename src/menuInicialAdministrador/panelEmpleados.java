...
public class panelEmpleados extends JPanel {
    ...
    public void cargarDatosEmpleados() {
        ...
        try (Connection conn = ConnectionADMIN.getConnectionADMIN()) { // Obtiene la conexión a la base de datos
            ...
            List<Persona> listaPersonas = personasDAO.obtenerTodasLasPersonasEmpleados(conn); // Pasa la conexión al método
    ...
    public void generarPdfEmpleados(Persona persona, String filePath) { // ¡Método actualizado para aceptar filePath!
        ...
        try {
            ...
            document.add(new Paragraph("Reporte de Empleado - " + persona.getNumeroIdentificacion()).setFontSize(18).setBold());
